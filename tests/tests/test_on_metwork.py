...
from repeaters_NV import RepeaterParams, QuantumRepeaterNetwork, build_s2_graph
...
MULTIPLEXING_TYPE = None           # <-- e.g. 'accumulated' if you use M=20 multiplexing
DISTILLATION      = False
...
def build_network():
    if USE_REAL_GRAPH:
        try:
            A, dist, coords = build_s2_graph(N=N_NODES, beta=2.6261, mu=0.0233, scale='city')
